...
import creation.board.model.dao.HPQNABoardDAO;
import creation.board.model.dto.HPBoardDTO;
import creation.board.model.dto.PageInfoDTO;

public class HPQNABoardService {

	private final HPQNABoardDAO BoardDAO;
	
	public HPQNABoardService() {
		
		BoardDAO = new HPQNABoardDAO();
