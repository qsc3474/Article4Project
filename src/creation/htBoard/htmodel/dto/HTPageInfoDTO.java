...
public class HTPageInfoDTO implements java.io.Serializable{
	...
	public HTPageInfoDTO() {
	}
	public HTPageInfoDTO(int pageNo, int totalCount, int limit, int buttonAmount, int maxPage, int startPage, int endPage,
