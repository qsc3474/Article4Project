                ...
                <div class="row justify-content-center">
                    <div class="col-11 col-sm-10 col-md-10 col-lg-6 col-xl-5 text-center p-0 mt-3 mb-2">
                        <div class="card px-0 pt-4 pb-0 mt-3 mb-3">
                            <form id="msform" action="${pageContext.request.contextPath}/ht/event/delete" method="get">
		                       	<input type="hidden" name="no" value="${requestScope.HTeventDetail.eventNo }">
							<fieldset>
                                    <div class="form-card">
                                        <div class="row">
                                            <div class="col-7">
                                        	...
                                        	<input type="text"  placeholder="${requestScope.HTeventDetail.eventNo }" />
                                        	
                                    		<label class="fieldlabels">이벤트룸<span class="text-danger">*</span></label>
                                        	<input type="text"  placeholder="${requestScope.HTeventDetail.eventType }" />
                                        	
                                    		<label class="fieldlabels">체크인<span class="text-danger">*</span></label>
                                        	<input type="text"  placeholder="${requestScope.HTeventDetail.time }" />
                                        	
                                    		<label class="fieldlabels">체크아웃<span class="text-danger">*</span></label>
                                        	<input type="text"  placeholder="${requestScope.HTeventDetail.timeOut }" />
                                        	
                                    		<label class="fieldlabels">투숙 마리<span class="text-danger">*</span></label>
                                        	<input type="text"  placeholder="${requestScope.HTeventDetail.petNo }" />
                                        	
                                    		<label class="fieldlabels">이름<span class="text-danger">*</span></label>
                                        	<input type="text"  placeholder="${requestScope.HTeventDetail.petName }" />
                                        	
                                            <label class="fieldlabels">분류 (종)<span class="text-danger">*</span></label>
											<input type="text" value="${requestScope.HTeventDetail.kind }" readonly> 
											
                                            <label class="fieldlabels">성별 <span class="text-danger">*</span></label> 
                                            <input type="text" value="${requestScope.HTeventDetail.petGender }"readonly> 
                                            
                                            <label class="fieldlabels">나이<span class="text-danger">*</span></label>
											<input type="text" value="${requestScope.HTeventDetail.petAge }"readonly> 
											
                                            <label class="fieldlabels">중성화여부<span class="text-danger">*</span></label>
											<input type="text" value="${requestScope.HTeventDetail.petNeut }"readonly> 
	
                                            <label for="exampleFormControlTextarea1">특이사항</label>
                                            <input type="text" value="${requestScope.HTeventDetail.message }"readonly>
                                    ...
                                    <input type="button" id="home3" class="previous action-button-previous"
                                        value="돌아가기" />
                                    <input type="button" name="roomDelete" id="roomDelete" class="next action-button" value="예약취소" onclick="location.href='${ pageContext.servletContext.contextPath}/ht/event/delete?no=${ requestScope.HTeventDetail.eventNo }'"/>
                                </fieldset>
                                </form>
                              </div>
                           </div>
...
if (document.getElementById("home3")) {
...
if (document.getElementById("no")) {
	...
	$no.onclick = function() {
		location.href = "${pageContext.request.contextPath}/ht/event/delete";   
	}
}
</script>
</body>
