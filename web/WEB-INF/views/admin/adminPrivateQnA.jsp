                                                ...
                                                <div class="table-responsive table_e2">
                                                    <table class="table table-hover table-vcenter text-nowrap mb-0">
                                                        ...
                                                        <tbody>
                                                         ...
                                                         <c:forEach var="pri" items="${requestScope.privateQnaList }">                                                           <tr>
                                                              
                                                               
                                                                <td><c:out  value="${pri.no }"/></td>
                                                                <td><c:out value="${pri.title }"/></td>
                                                                <td><c:out value="${pri.content }"/></td>
                                                                <td><c:out value="${pri.drawupDate }"/></td>
                                                                <td><c:out value="${pri.writer.no }"/></td>
