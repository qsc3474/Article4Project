	...
	<section class="notice-sec bg-white">
							...
							<div class="row">
								<div class="col-md-12">
									<div class="panel panel-default panel-wrap">
										<form
											action="${pageContext.request.contextPath}/admin/book/update"
											method="get">
													...
													<c:forEach var="book" items="${requestScope.allBookList }">
														<tr>
															...
															<td><input type="hidden" name="no"
																value="${book.no }">
																<button type="button"
																	class="btn btn-primary btn-sm submitBtn" title="Edit">
																	<i class="fa fa-edit"></i>
																</button>
																<button type="button"
																	class="btn btn-danger btn-sm deleteBtn" title="Delete"
																	id="deleteBook">
		...
		<script>
    		   ...
    		   $(".submitBtn").click(function(){
                  ...
                  var no = getNo.value;
                  console.log(no);
                  location.href = "${pageContext.request.contextPath}/admin/book/update?no=" + no;
