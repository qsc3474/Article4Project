	...
	<jsp:include page="/WEB-INF/views/hotel/common/header.jsp"/>
	 <section>
        ...
        <div class="container"  role="main">
                <form name="form" id="form" role="form" action="${ pageContext.servletContext.contextPath }/ht/QNA/delete" method="post">
                ...
                <div class="text-center" style="margin-top: 20px;">
                    <button  class="btn btn-primary btn-lg" onclick="location.href='${ pageContext.servletContext.contextPath}/ht/QNA/update?no=${ requestScope.htnotice.no }'">
					수정하기</button>
                    <button type="button" class="btn btn-secondary btn-lg" id="btnList">목록</button>
                    <button  class="btn btn-primary btn-lg" id=delete name="delete" onclick="location.href='${ pageContext.servletContext.contextPath}/ht/QNA/delete?no=${ requestScope.htnotice.no }'">
					삭제하기</button>
                </div>
       		 </div>
        <script>
